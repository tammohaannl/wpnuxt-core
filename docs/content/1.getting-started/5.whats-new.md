...
WPNuxt v2 requires Nuxt 4.0+ and Node.js 20+. The codebase uses the Nuxt 4 directory structure (`app/` for client code, `server/` for server code) and benefits from Nuxt 4's improved performance and module system.
